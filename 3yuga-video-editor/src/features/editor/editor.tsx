...
// import { design } from "./mock"; // Removed - not using mock data
...
const Editor = ({ tempId, id }: { tempId?: string; id?: string }) => {
	...
	// Commented out to start with empty editor instead of loading mock data
	// useEffect(() => {
			...
			<div className="flex flex-1 overflow-hidden">
				{isLargeScreen && (
					<div className="flex flex-none">
						<MenuList />
						<div 
							className="bg-muted flex flex-col flex-none border-r border-border/80 w-[300px] overflow-y-auto"
						>
							<MenuItem />
						</div>
					</div>
				...
				<div 
					className="bg-muted flex flex-col flex-none border-l border-border/80 w-[272px] overflow-y-auto hidden lg:flex"
					style={{
